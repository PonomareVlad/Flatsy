...
'</header><div class="arrow-top"></div><div class="calendar"><div id="prev"></div><div id="calendar"></div><div id="next"></div></div>';
...
'<li id="finished" onclick="set_vmode(\'finished\');">Завершенные</li>' +
